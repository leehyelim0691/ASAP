...
export const UserChartSeries = [{ name: "User", data: [28, 40, 36, 52, 38, 60, 55] }];
...
export const VisitorChartSeries = [{ name: "User", data: [28, 40, 36, 52, 38, 60, 55] }];
...
export const BounceChartSeries = [{ name: "Bonus Rate", data: [28, 40, 36, 52, 38, 60, 55] }];
...
export const AverageVisitTimeChartSeries = [{ name: "User", data: [28, 40, 36, 52, 38, 60, 55] }];
...
/** Order Column Chart Series and options used in Front side Instructor Dashboard page */
export const PayoutChartSeries = [{ name: "Inflation", data: [40, 20, 50, 80, 65] }];
...
export const TotalEarningChartSeries = [{ data: [50, 80, 5, 90, 12, 150, 12, 80, 150] }];
...
export const BudgetExpenseChartSeries = [{ name: "Series 1", data: [90, 32, 30, 40, 100, 20] }];

                ...
                return (
                  <tr key={index}>
                    <td className=" border-top-0">
                      <Icon path={item.icon} size={0.6} className="text-primary" />
                      <span className="ms-2 d-none d-md-inline-block">{item.media}</span>
                    </td>
                    ...
                    <td className="w-25 ps-3 align-middle border-top-0 ">
                      <ProgressBar variant={item.progressbarvariant} now={item.percent} className="mb-2" style={{ height: "5px" }} />
                    </td>
                  </tr>
                );
              })}

    ...
    <Fragment>
      ...
      <Row>
        <Col xl={3} lg={6} md={12} sm={12}>
          <StatRightChart title="USER" value="30.6k" summary="Number of sales" summaryValue="+20.9$" summaryIcon="up" showSummaryIcon classValue="mb-4" chartName="UserChart" />
        </Col>

        <Col xl={3} lg={6} md={12} sm={12}>
          <StatRightChart title="UNIQUE VISITORS" value="256k" summary="Number of pending" summaryValue="5%" summaryIcon="down" showSummaryIcon classValue="mb-4" chartName="VisitorChart" />
        </Col>

        <Col xl={3} lg={6} md={12} sm={12}>
          <StatRightChart title="BOUNCE RATE" value="51.46%" summary="Students" summaryValue="+1200" summaryIcon="up" showSummaryIcon classValue="mb-4" chartName="BounceChart" />
        </Col>

        <Col xl={3} lg={6} md={12} sm={12}>
          <StatRightChart title="AVERAGE VISIT TIME" value="1m:17s" summary="Instructor" summaryValue="12%" summaryIcon="up" showSummaryIcon classValue="mb-4" chartName="AverageVisitTimeChart" />
        </Col>
      </Row> */}
        ...
        <Col xl={4} lg={12} md={12} className="mb-4">
          <Card className="h-100">
            ...
            <Card.Body>
              ...
              <ApexCharts options={ActiveUserChartOptions} series={ActiveUserChartSeries} type="bar" />
            </Card.Body>
          </Card>
        </Col>
      </Row> */}
      ...
      <Row>
        <Col xl={8} lg={12} md={12} className="mb-4">
          <Card className="h-100">
            ...
            <Card.Body className="p-1">
              <ApexCharts options={TrafficChannelChartOptions} series={TrafficChannelChartSeries} type="donut" height={260} />
                ...
                <Table className="w-100 mt-5 text-nowrap" borderless>
                  <tbody>
                    <tr>
                      ...
                      <td className="text-end fw-semi-bold py-1 text-dark">2,120</td>
                    ...
                    <tr>
                      ...
                      <td className="text-end fw-semi-bold py-1 text-dark">639</td>
                    ...
                    <tr>
                      ...
                      <td className="text-end fw-semi-bold py-1 text-dark">520</td>
                    ...
                    <tr>
                      ...
                      <td className="text-end fw-semi-bold  pt-1 text-dark">116</td>
        ...
        {/* <Col xl={4} lg={12} md={12} className="mb-4">
          <Card className="h-100">
            ...
            <Card.Body>
              <ApexCharts options={OperatingSystemChartOptions} series={OperatingSystemChartSeries} type="polarArea" height={350} />

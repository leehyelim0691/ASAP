...
const Password = ({ id, label, placeholder, value, input, width, create }) => {
      ...
      {create === "1" ? (
        <Form.Group controlId={id}>
          ...
          <Row>
            <Col sm="1"> </Col>
            <Col sm="11">
              <Form.Control type="text" placeholder={placeholder} required />
            </Col>
          </Row>
        </Form.Group>
      ) : (
        <Form.Group controlId={id}>
          {/* <Form.Label>{label}</Form.Label> */}
          <Form.Control type="text" placeholder={placeholder} required className="form-control-plaintext " defaultValue={label} />
          <Form.Control type="password" placeholder={placeholder} required />
        </Form.Group>
      )}
    </Col>
  );
